...
- Supplementary product content such as [Example Scenes](https://github.com/rlguy/Blender-FLIP-Fluids/wiki/Example-Scene-Descriptions) and [Preset Library Scenes](Preset-Library-Installation-and-Uninstallation) will not be available in the demo.

### Getting Started

Download the latest FLIP Fluids Demo installation file here: [FLIP_Fluids_addon_0.6.5_demo_(07_jun_2023.zip)](https://github.com/rlguy/Blender-FLIP-Fluids/releases/download/v0.6.5/FLIP_Fluids_addon_0.6.5_demo_.07_jun_2023.zip)
